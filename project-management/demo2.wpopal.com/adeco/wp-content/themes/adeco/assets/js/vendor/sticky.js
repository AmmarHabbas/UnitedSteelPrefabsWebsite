(function ($, elementorFrontend, elementorModules) {
    ...
    function _vertical_line($scope) {
        if ($scope.hasClass('adeco-vertical-line-yes')) {
            $scope.append( '<div class="elementor-vertical-lines"><div class="col-full"><div class="line-wrap"></div><div class="line-wrap"></div></div></div>' );
        }
    }
